...
st.set_page_config(page_title='Cropper System ● gurpinder pal singh ● CO21318', page_icon='🌱', layout='centered', initial_sidebar_state="collapsed")
...
def main():
    ...
    '''
        ...
        st.write('''
                    🌾 © 2024 Cropper System • Created by Gurpinder pal singh• CO21318 🌾
                ''')
